...
class JuridicoController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_Juridico();
    ...
    public function indexAction()
    {
        ...
        $this->view->barTitle = 'Jurídico';       
    }

    public function addAction()
    {
        $form = new Application_Form_Juridico();
        $request = $this->_request;
        ...
        $this->view->form = $form;
        $this->view->barTitle = 'Novo atendimento jurídico';
    }
    ...
    public function editAction()
    {
        ...
        $form->populate($data);
        $this->view->form = $form;
        $this->view->barTitle = 'Editando atendimento jurídico';
    }
    ...
    public function relatoriosAction()
    {
        ...
        $this->view->paginator = $paginator;
        $this->view->barTitle = 'Relatório Jurídico';
    }
