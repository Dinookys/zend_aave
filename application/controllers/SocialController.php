...
class SocialController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_Social();
    ...
    public function addAction()
    {
        ...
        if($request->isPost()){
           ...
           if($form->isValid($data)){
               ...
               if($insert){
                   $this->_FlashMessenger->setNamespace($this->_controllerName)->addMessage('Visita adicionada com sucesso!');
        ...
        $this->view->form = $form;
        $this->view->barTitle = 'Novo atendimento social';
    ...
    public function editAction()
    {
        ...
        $form->populate($data);
        $this->view->form = $form;
        $this->view->barTitle = 'Editando atendimento social';
    }
    ...
    public function relatoriosAction()
    {
        ...
        $this->view->paginator = $paginator;
        $this->view->barTitle = 'Relatório Social';
    }
