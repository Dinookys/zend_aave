...
class DoacoesController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_Doacoes();
    ...
    public function indexAction()
    {
        ...
        $this->view->barTitle = 'Doações';       
    }

    public function addAction()
    {
        $form = new Application_Form_Doacao();
        $request = $this->_request;
        ...
        $this->view->form = $form;
        $this->view->barTitle = 'Nova doação';
    }
    ...
    public function editAction()
    {
        ...
        $form->populate($data);
        $this->view->form = $form;
        $this->view->barTitle = 'Editando doação';
