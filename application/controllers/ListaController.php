...
class ListaController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_Lista();
    ...
    public function indexAction()
    {
        ...
        $this->view->barTitle = 'Participando';   
    }

    public function addAction()
    {
        $form = new Application_Form_Lista();
        $request = $this->_request;
        ...
        $this->view->form = $form;
        $this->view->barTitle = 'Nova participação';
    ...
    public function editAction()
    {
        ...
        $form->populate($data);
        $this->view->form = $form;
        $this->view->barTitle = 'Editando participação';
    }
