...
class PsicologicoController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->_model = new Application_Model_Psicologico();
    ...
    public function indexAction()
    {
        ...
        $this->view->barTitle = 'Psicológico';       
    }

    public function addAction()
    {
        $form = new Application_Form_Psicologico();
        $request = $this->_request;
        ...
        $this->view->form = $form;
        $this->view->barTitle = 'Novo atendimento psicológico';
    }
    ...
    public function editAction()
    {
        ...
        $form->populate($data);
        $this->view->form = $form;
        $this->view->barTitle = 'Editando atendimento psicológico';
